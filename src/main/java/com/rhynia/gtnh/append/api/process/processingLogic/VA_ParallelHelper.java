...
public class VA_ParallelHelper extends GT_ParallelHelper {
     ...
     */
    private final MaxParallelCalculator maxParallelCalculator = VA_ParallelHelper::maxParallelCalculatedByInputs;
    /**
     * Method for consuming inputs after determining how many parallels it can execute.
     */
    private final InputConsumer inputConsumer = VA_ParallelHelper::consumeInput;
    ...
    /**
     * Finishes the GT_ParallelHelper. Anything changed after this will not affect anything
     */
            ...
            nextRecipeItemCost: for (Map.Entry<TST_ItemID, Long> itemID : itemCost.entrySet()) {
                ...
                for (ItemStack providedItem : aInputs) {
                    if (isNBTSensitive && !GT_Utility.areStacksEqual(providedItem, unifiedItemCost, false)) {
                        ...
                        if (!isNBTSensitive && !GT_OreDictUnificator.isInputStackEqual(providedItem, unifiedItemCost)) {
                            continue;
                        }
