...
public class BWPart {
     ...
     *
     * @param aIndex  To call the meta of it, see BWPart
     * @param aAmount The amount of ItemStack
     * @author Rhynia
     * @since 0.6.13-pre
     */
    public static ItemStack getWrappedPart(WrappedPart aIndex, int aAmount) {
        if (aAmount > 64) return GT_Utility.copyAmountUnsafe(
            ...
            GT_ModHandler.getModItem(
                ...
                1,
                aIndex.ordinal() + WrapCircuit_Offset,
