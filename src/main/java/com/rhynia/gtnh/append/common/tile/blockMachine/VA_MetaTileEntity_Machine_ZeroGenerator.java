...
import static com.rhynia.gtnh.append.api.util.enums.VA_Values.CommonStrings.AddByAppend;
import static com.rhynia.gtnh.append.api.util.enums.VA_Values.TextureSets.VA_LOGO_32;
...
public class VA_MetaTileEntity_Machine_ZeroGenerator extends GT_MetaTileEntity_TieredMachineBlock
    ...
    public MetaTileEntity newMetaEntity(IGregTechTileEntity aTileEntity) {
        return new VA_MetaTileEntity_Machine_ZeroGenerator(mName, mTier, mDescriptionArray, mTextures);
    }
    ...
    public long maxEUStore() {
        return WIRELESS ? Math.abs((long) EUT * AMP * 24) : Math.abs((long) EUT * AMP) << 2;
    }
    ...
    public boolean canConnect(ForgeDirection side) {
        return WIRELESS && side != getBaseMetaTileEntity().getFrontFacing();
    }
