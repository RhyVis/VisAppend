...
public class ItemRegister {
    ...
    public static void registryItemContainers() {
        // Meta Item 01
        VA_ItemList.Test01.set(initItem01("调试占位-01",0, new String[]{ "我相信它没什么用" }));
        ...
        VA_ItemList.AstriumInfinityGem.set(initItem01("星极",4, new String[]{ "Aμⁿ", "浓缩的极限能量" }));
        VA_ItemList.LensAstriumInfinity.set(initItem01("星极天体透镜", 5, new String[]{ "能量聚集于此" }));
        VA_ItemList.LensAstriumMagic.set(initItem01("星芒魔力透镜", 6, new String[]{ "我想它能自行产生魔力" }));
        VA_ItemList.LensPrimoium.set(initItem01("原石透镜", 7, new String[]{ "异世界的能量?" }));
        VA_ItemList.LensOriginium.set(initItem01("源石透镜", 8, new String[]{ "操作时请注意源石尘" }));
        VA_ItemList.PreTesseract.set(initItem01("准超立方体", 9, new String[]{ "即将达到高维工程学" }));
        VA_ItemList.AstriumInfinityComplex.set(initItem01("星矩", 10, new String[]{ "-[Aμⁿ-Aμⁿ]-", EnumChatFormatting.DARK_RED + "高维能量络合物" }));
        // Meta Item 02
