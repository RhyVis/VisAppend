...
public class ItemRegister {
    ...
    public static void registryItemContainers() {
        ...
        VAItemList.AstriumInfinityGem.set(initItem01("星极",51, new String[]{ "Aμⁿ", "浓缩的极限能量" }));
        VAItemList.LensAstriumInfinity.set(initItem01("星极天体透镜", 101, new String[]{ "能量聚集于此" }));
        VAItemList.LensAstriumMagic.set(initItem01("星芒魔力透镜", 102, new String[]{ "我想它能自行产生魔力" }));
        VAItemList.LensPrimoium.set(initItem01("原石透镜", 103, new String[]{ "异世界的能量?" }));
        VAItemList.LensOriginium.set(initItem01("源石透镜", 104, new String[]{ "操作时请注意源石尘" }));
        // Special Item
