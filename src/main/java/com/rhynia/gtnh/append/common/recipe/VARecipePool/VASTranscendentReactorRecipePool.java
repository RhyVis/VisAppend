...
public class VASTranscendentReactorRecipePool implements IRecipePool {
    ...
    public void loadTRDTCRecipes() {
        ...
        VA_RecipeBuilder.builder()
            ...
            .fluidInputs(
                VA_Materials.AstralCatalystBaseExcited.getFluidOrGas(CatalystACA / 4),
                Materials.Helium.getGas(RecipeMult * INGOTS))
            .fluidOutputs(
                MaterialsUEVplus.ExcitedDTCC.getFluid(RecipeMult * OutputMult),
                VA_Materials.AstralResidue.getFluidOrGas(CatalystACA / 8))
        ...
        VA_RecipeBuilder.builder()
            ...
            .fluidInputs(
                VA_Materials.AstralCatalystBaseExcited.getFluidOrGas(CatalystACA / 2),
                Materials.Helium.getGas(RecipeMult * INGOTS),
                Materials.Radon.getGas(RecipeMult * INGOTS))
            .fluidOutputs(
                MaterialsUEVplus.ExcitedDTPC.getFluid(RecipeMult * OutputMult),
                VA_Materials.AstralResidue.getFluidOrGas(CatalystACA / 4))
        ...
        VA_RecipeBuilder.builder()
            ...
            .fluidInputs(
                VA_Materials.AstralCatalystBaseExcited.getFluidOrGas(CatalystACA),
                Materials.Helium.getGas(RecipeMult * INGOTS),
                Materials.Radon.getGas(RecipeMult * INGOTS),
                Materials.Nitrogen.getGas(RecipeMult * INGOTS))
            .fluidOutputs(
                MaterialsUEVplus.ExcitedDTRC.getFluid(RecipeMult * OutputMult),
                VA_Materials.AstralResidue.getFluidOrGas(CatalystACA / 2))
        ...
        VA_RecipeBuilder.builder()
            ...
            .fluidOutputs(
                ...
                VA_Materials.AstralResidue.getFluidOrGas(CatalystACA))
    ...
    public void loadMiscRecipes() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_Utility.getIntegratedCircuit(10), VA_ItemList.AstriumInfinityGem.get(4))
            .fluidInputs(
            ...
            .fluidOutputs(SCPart.UV.getMolten(16344 * INGOTS), VA_Materials.AstralResidue.getFluidOrGas(4 * BUCKETS))
            .noOptimize()
            .eut(RECIPE_UXV)
            .duration(4 * SECONDS)
            .addTo(TR);
        // UHV
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_Utility.getIntegratedCircuit(10), VA_ItemList.AstriumInfinityGem.get(8))
            .fluidInputs(
            ...
            .fluidOutputs(SCPart.UHV.getMolten(8064 * INGOTS), VA_Materials.AstralResidue.getFluidOrGas(8 * BUCKETS))
            .noOptimize()
            .eut(RECIPE_UXV)
            .duration(8 * SECONDS)
            .addTo(TR);
        // UEV
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_Utility.getIntegratedCircuit(10), VA_ItemList.AstriumInfinityGem.get(16))
            .fluidInputs(
            ...
            .fluidOutputs(SCPart.UEV.getMolten(2016 * INGOTS), VA_Materials.AstralResidue.getFluidOrGas(16 * BUCKETS))
            .noOptimize()
            .eut(RECIPE_UXV)
            .duration(16 * SECONDS)
            .addTo(TR);
        // UIV
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_Utility.getIntegratedCircuit(10), VA_ItemList.AstriumInfinityGem.get(32))
            .fluidInputs(
            ...
            .fluidOutputs(SCPart.UIV.getMolten(1000 * INGOTS), VA_Materials.AstralResidue.getFluidOrGas(32 * BUCKETS))
            .noOptimize()
            .eut(RECIPE_UXV)
            .duration(32 * SECONDS)
            .addTo(TR);
        // UMV
        GT_Values.RA.stdBuilder()
            .itemInputs(GT_Utility.getIntegratedCircuit(10), VA_ItemList.AstriumInfinityGem.get(64))
            .fluidInputs(
            ...
            .fluidOutputs(SCPart.UMV.getMolten(972 * INGOTS), VA_Materials.AstralResidue.getFluidOrGas(64 * BUCKETS))
            .noOptimize()
            .eut(RECIPE_UXV)
            .duration(64 * SECONDS)
            .addTo(TR);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(VA_Materials.AstriumMagic.get(OrePrefixes.dust, 16))
            .fluidInputs(
                VA_Materials.AstralCatalystBaseExcited.getFluidOrGas(48 * BUCKETS),
                Materials.Helium.getPlasma(6 * BUCKETS),
                Materials.DraconiumAwakened.getMolten(12 * INGOTS),
                Materials.Indium.getMolten(7 * INGOTS))
            .fluidOutputs(
                VA_Materials.SuperconductorFlux.getFluidOrGas(72 * INGOTS),
                VA_Materials.AstralResidue.getFluidOrGas(24 * BUCKETS))
            .specialValue((int) HeatingCoilLevel.UEV.getHeat())
            .noOptimize()
            .eut(RECIPE_UIV)
            .duration(20 * SECONDS)
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(
                ...
                VA_Materials.AstriumMagic.get(OrePrefixes.dust, 64),
                VA_Materials.AstriumInfinity.get(OrePrefixes.dust, 64),
                VA_Materials.Astrium.get(OrePrefixes.dust, 64),
                VA_Materials.AstriumMagic.get(OrePrefixes.dust, 64),
                VA_Materials.AstriumInfinity.get(OrePrefixes.dust, 64))
            ...
            .fluidOutputs(
                ...
                VA_Materials.AstralResidue.getFluidOrGas(10 * BUCKETS),
