...
public abstract class GT_MetaTileEntity_Append_Hatch_FluidGenerator extends GT_MetaTileEntity_Hatch_Input {
    ...
    public GT_MetaTileEntity_Append_Hatch_FluidGenerator(final String aName, final int aTier, final String[] aDescription,
    ...
    public synchronized String[] getDescription() {
        mDescriptionArray[1] = "容量: " + GT_Utility.formatNumbers(getCapacity()) + "L";
        final String[] hatchTierString = new String[] { "仓室等级: " + GT_Utility.getColoredTierNameFromTier(mTier) };
