    ...
    public void loadRecipesCompleteInit() {
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                VA_Materials.Astrium.get(OrePrefixes.dust, 12))
            .itemOutputs(Materials.Neutronium.getIngots(2))
            .fluidOutputs(VA_Materials.AstriumMagic.getMolten(12), Materials.Neutronium.getMolten(2304))
            .noOptimize()
            .eut(RECIPE_LuV)
            .duration(25 * SECONDS)
            .addTo(HM);
        ...
        GT_Values.RA.stdBuilder()
            ...
            .fluidOutputs(VA_Materials.AstriumMagic.getMolten(12), Materials.CosmicNeutronium.getMolten(2304))
            .noOptimize()
            .eut(RECIPE_LuV)
            .duration(25 * SECONDS)
            .addTo(HM);
        ...
        GT_Values.RA.stdBuilder()
            .itemInputs(
                ...
                VA_Materials.Astrium.get(OrePrefixes.dust, 12))
            .fluidOutputs(
                VA_Materials.AstriumMagic.getMolten(12),
        ...
        // 兰波顿矩阵
        GT_Values.RA.stdBuilder()
            .itemInputs(CustomItemList.LapotronDust.get(64), VA_Materials.Astrium.get(OrePrefixes.dust, 16))
            .itemOutputs(VA_ItemList.LapoMatrix.get(4))
            .fluidInputs(VA_Materials.LapotronEnhancedFluid.getFluidOrGas(12 * BUCKETS))
            .noOptimize()
            .eut(RECIPE_LuV)
            .duration(40 * SECONDS)
            .addTo(HM);
        // 晶体矩阵
        GT_Values.RA.stdBuilder()
            .itemInputs(Materials.Aluminiumoxide.getDust(64), VA_Materials.Astrium.get(OrePrefixes.dust, 16))
            .itemOutputs(VA_ItemList.CrystalMatrix.get(16))
        ...
        GT_Values.RA.stdBuilder()
            ...
            .itemOutputs(VA_ItemList.DenseMicaInsulatorFoil.get(1))
            .noOptimize()
            .eut(RECIPE_LV)
            .duration(5 * SECONDS)
            .addTo(HM);
